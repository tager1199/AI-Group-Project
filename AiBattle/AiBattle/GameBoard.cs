...
namespace AiBattle
{
    class GameBoard
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (deployingA == true || deployingB == true || deployingC == true || deployingS == true || deployingD)
            {
                ...
                while (no_valid_direction == true)
                {
                    ...
                    while (error == true || successful_deployment == false)
                    {
                            ...
                            case "left":
                                ...
                                if (successful_deployment == false)
                                {
                                    ...
                                    if (start_posX - ship_size >= 0)
                                    {
                                        ...
                                        {
                                            if (battleship_matrix[start_posY - 1, start_posX - ship_size_temp] == "0")  //if the space is empty before placement, then you can change position
                                            {
                                                successful_deployment = true;
                                ...
                                {                                   ///HAVE NOT ADDED FIX IF USER CANNOT PLACE A SHIP IN ANY DIRECTION WITHOUT COLLIDING OR GOING OUT OF BOUNDS
                                    ...
                                    if (start_posX + ship_size <= 11)
                                    {
                                        ...
                                        while (count != ship_size && successful_deployment == true)
                                        {
                                            ...
                                            if (battleship_matrix[start_posY - 1, start_posX + count - 1] == "0")  //if the space is empty before placement, then you can change position
                                            {
                                                successful_deployment = true;
                                ...
                                if (successful_deployment == false)
                                {
                                    ...
                                    if (start_posY - ship_size >= 0)
                                    {
                                        ...
                                        while (ship_size_temp != count && successful_deployment == true)
                                        {
                                            ...
                                            if (battleship_matrix[start_posY - ship_size_temp, start_posX - 1] == "0")  //if the space is empty before placement, then you can change position
                                            {
                                                successful_deployment = true;
                                ...
                                if (successful_deployment == false)
                                {
                                    ...
                                    if (start_posY + ship_size <= 11)
                                    {
                                        ...
                                        while (count != ship_size && successful_deployment == true)
                                        {
                                            ...
                                            if (battleship_matrix[start_posY + count - 1, start_posX - 1] == "0")  //if the space is empty before placement, then you can change position
                                            {
                                                successful_deployment = true;
                        ...
                        if (successful_deployment == false)
                        {
                            if (collision_error_count >= 2 || first_placement == 1)
                            {
                                collision_error_count = 0;
            ...
            string[,] HitArray = new string[10, 10];
            for (int i = 0; i < 10; i++)
            {
                for (int j = 0; j < 10; j++)
                {
            ...
            while (shipsSunk < 5 && playerShipsSunk < 5)
            {
